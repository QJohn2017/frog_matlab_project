...
[ phase_send1, lambda_send1 ] = phase_prepare( 'Speck13.dat', 720, 840, -1, 0, 0);
...
[ phase_send2, lambda_send2 ] = phase_prepare( 'Speck13_2.dat', 720, 840, 1, 0, 0);
figure(2)
...
% retrieve third phase
[ phase_send3, lambda_send3 ] = phase_prepare( 'Speck13_3.dat', 720, 840, -1, 0, 0);
figure(5)
plot(lambda_send3, phase_send3)
title('retrieve second phase')
% correct the wavelength axis with a spline interpolation
phase_send3_corr = spline(lambda_send3, phase_send3, lambda_send1);
figure(6)
plot(lambda_send1, phase_send3_corr)
title('mapped to same x axis')
figure(7)

phase_send_final = phase_send2_corr + phase_send3_corr + phase_send1;
plot(lambda_send1, phase_send_final)
title('summation of two  phase measurements')
